...
const OurHistory = () => {
  ...
  const historyItems = [
    ...
    { title: <Text className="font-bold text-blue-600">2025</Text>, children: 'Celebrating 25 years of educational superiority.' },
  ];
